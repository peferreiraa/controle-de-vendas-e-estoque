...
public class FrmProvider extends javax.swing.JFrame {
    ...
    public void toListTable() {
        ...
        DefaultTableModel datas = (DefaultTableModel) providerTable.getModel();
        datas.setNumRows(0);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(990, 654));
        ...
        panelDatasLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtCNPJ, txtCelular, txtCep, txtCidade, txtComplemento, txtEmail, txtEndereco, txtTelefone});
        ...
        jTabbedPane1.addTab("Consultar Fornecedores", pnlConsultaClientes);

        jLabel16.setFont(new java.awt.Font("Tahoma", 1, 30)); // NOI18N
        jLabel16.setText("Cadastro e Consulta de Fornecedores");
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/pesquisar.png"))); // NOI18N
        jLabel4.setText("jLabel4");

        jLabel17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/fornecedor.png"))); // NOI18N

        javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
        jPanel1.setLayout(jPanel1Layout);
        jPanel1Layout.setHorizontalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 990, Short.MAX_VALUE)
    ...
    private void txtPesquisaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPesquisaKeyPressed
        ...
        ProviderDao dao = new ProviderDao();
        List<Provider> list = dao.searchByName(nome);
        DefaultTableModel datas = (DefaultTableModel) providerTable.getModel();
        datas.setNumRows(0);
    ...
    private void providerTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_providerTableMouseClicked
        ...
        txtCodigo.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 0).toString());
        txtNome.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 1).toString());
        txtCNPJ.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 2).toString());
        txtEmail.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 3).toString());
        txtTelefone.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 4).toString());
        txtCelular.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 5).toString());
        txtCep.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 6).toString());
        txtEndereco.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 7).toString());
        txtNumero.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 8).toString());
        txtComplemento.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 9).toString());
        txtBairro.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 10).toString());
        txtCidade.setText(providerTable.getValueAt(providerTable.getSelectedRow(), 11).toString());
        cbUf.setSelectedItem(providerTable.getValueAt(providerTable.getSelectedRow(), 12).toString());
